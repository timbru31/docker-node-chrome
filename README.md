...
A minimal Dockerfile based on Node.js 14 LTS (Fermium), Node.js 16 LTS (Gallium) or Node.js 18 (Hydrogen) branch (regular, slim or alpine) with the stable Chromium installed.
